...
from swagger_client.models.existing_recipe import ExistingRecipe


class TestExistingRecipe(unittest.TestCase):
    """ ExistingRecipe unit test stubs """
    ...
    def testExistingRecipe(self):
        """
        Test ExistingRecipe
        """
        model = swagger_client.models.existing_recipe.ExistingRecipe()
